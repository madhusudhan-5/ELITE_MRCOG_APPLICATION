"""
Django settings for elitemrcog project.
"""
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='contact@elitemrcog.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=False, cast=bool)
EMAIL_USE_SSL = config('EMAIL_USE_SSL', default=True, cast=bool)
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=config('EMAIL_HOST_USER', default='contact@elitemrcog.com'))
...
SUMMERNOTE_CONFIG = {
    ...
    # Enable attachment to prevent NoReverseMatch error in Admin
...
# Allow up to 500MB uploads for video files
